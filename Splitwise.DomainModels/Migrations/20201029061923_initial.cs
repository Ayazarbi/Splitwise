        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Balacnce = table.Column<double>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Friends_AspNetUsers_FrndId",
                        column: x => x.FrndId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupMembers", x => x.GroupMembersId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupsofExpenses", x => x.GroupExpenseId);
                    table.ForeignKey(
                        name: "FK_GroupsofExpenses_Expenses_ExpenseId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Settelements", x => x.SettelementId);
                    table.ForeignKey(
                        name: "FK_Settelements_AspNetUsers_BorrowerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShareAmount = table.Column<double>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Shareinfo", x => x.ShareId);
                    table.ForeignKey(
                        name: "FK_Shareinfo_Expenses_ExpenseId",
                        column: x => x.ExpenseId,
                        principalTable: "Expenses",
                        principalColumn: "ExpenseId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Shareinfo_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LentedAmout = table.Column<double>(nullable: false),
                    UserId = table.Column<string>(nullable: true),
                    ShareId = table.Column<int>(nullable: false),
                    shareamount = table.Column<double>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Expensesinfo", x => x.ExpenseinfoId);
                    table.ForeignKey(
                        name: "FK_Expensesinfo_Expenses_ExpenseId",
                        column: x => x.ExpenseId,
                        principalTable: "Expenses",
                        principalColumn: "ExpenseId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Expensesinfo_Shareinfo_ShareId",
                        column: x => x.ShareId,
                        principalTable: "Shareinfo",
                        principalColumn: "ShareId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Expensesinfo_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Expensesinfo_ExpenseId",
                table: "Expensesinfo",
                column: "ExpenseId");

            migrationBuilder.CreateIndex(
                name: "IX_Expensesinfo_ShareId",
                table: "Expensesinfo",
                column: "ShareId");

            migrationBuilder.CreateIndex(
                name: "IX_Expensesinfo_UserId",
                table: "Expensesinfo",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Friends_FrndId",
                table: "Friends",
                column: "FrndId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Groups_CreatorIdId",
                table: "Groups",
                column: "CreatorIdId");

            migrationBuilder.CreateIndex(
                name: "IX_GroupsofExpenses_ExpenseId",
                table: "GroupsofExpenses",
                column: "ExpenseId");

            migrationBuilder.CreateIndex(
                name: "IX_GroupsofExpenses_GroupId",
                table: "GroupsofExpenses",
                column: "GroupId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Settelements_ExpenseId",
                table: "Settelements",
                column: "ExpenseId");

            migrationBuilder.CreateIndex(
                name: "IX_Settelements_GroupId",
                table: "Settelements",
                column: "GroupId");

            migrationBuilder.CreateIndex(
                name: "IX_Settelements_LenterId",
                table: "Settelements",
                column: "LenterId");

            migrationBuilder.CreateIndex(
                name: "IX_Shareinfo_ExpenseId",
                table: "Shareinfo",
                column: "ExpenseId");

            migrationBuilder.CreateIndex(
                name: "IX_Shareinfo_UserId",
                table: "Shareinfo",
                column: "UserId");
        }
